...
class REPLEnvLogger:
    def __init__(self, max_output_length: int = 2000, enabled: bool = True, log_level: int = logging.INFO):
        ...
        self.logger = logging.getLogger('RLM.REPL')
