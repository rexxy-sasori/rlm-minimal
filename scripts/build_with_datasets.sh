...
echo "  docker run -e OPENAI_API_KEY=sk-xxx $IMAGE_NAME python benchmarks/run_benchmarks.py --benchmark oolong --async"
echo ""
echo "For Kubernetes deployment:"  
echo "  kubectl apply -f deploy/k8s/benchmark-deployment.yaml"
echo ""
