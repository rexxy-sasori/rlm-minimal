...
```bash
docker-compose -f docker-compose.example.yml up -d timescaledb
```
...
4. **Docker Compose**: The `docker-compose.example.yml` file provides a complete example of running RLM with TimescaleDB.
